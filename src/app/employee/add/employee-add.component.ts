...
export class EmployeeAddComponent implements OnInit {
    ...
    doRegister() {
        ...
        const employeeRegister = this.employeeService.doRegisterEmployee(this.employeeAddForm.value, this.index);
        if (employeeRegister) {
    ...
    getEmployeeDetails(index: number) {
        const employeeDetail = this.employeeService.getEmployeeDetails(index);
